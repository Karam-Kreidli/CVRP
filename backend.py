...
def health_check():
    return {
        ...
        "stage_health": {
            ...
            "fleet_manager": 1.00, # TODO update these health scores based on your confidence in each component after testing. 1.00 means "fully healthy and tested", while lower scores indicate areas that might need attention. 
            "hgs_engine": 1.00, 
            "ppo_trainer": 1.00 # TODO update these health scores based on your confidence in each component after testing. 1.00 means "fully healthy and tested", while lower scores indicate areas that might need attention.    
        },
